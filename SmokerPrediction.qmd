...
Making hearing left and hearing right into one variable for better plotting
...
Separating out numeric and categorial variables
...
The goal here is to filter out the outliers
...
Here I will just separate out numeric and categorical variables. And also take extract out our target variable.
...
For numerical values I will be using MinMaxScaler for one attempt and StandardScaler for the other. 
...
Let's get us some training and testing data.
